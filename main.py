...
class WelcomeScreen(BoxLayout):
    def __init__(self, app):
        ...
        # Text unterhalb des Fragezeichens
        label = Label(
            ...
            color=(1, 1, 1, 1),
            size_hint=(1, 0.6),
            pos_hint={"center_y": 0.5}  # etwas unterhalb von oben
        )
...
class QuestionScreen(BoxLayout):
    def __init__(self, app):
        ...
        top.add_widget(Label())  # linker Platzhalter
        ...
        label = Label(
            ...
            color=(1, 1, 1, 1),
            size_hint=(1, 0.6),
            pos_hint={"center_y": 0.5}  # leicht unterhalb von oben
        )
        label.bind(size=label.setter("text_size"))
        self.add_widget(label)
...
class MainApp(App):
    ...
    def start_camera(self, was_yes):
        # Egal ob JA oder NEIN → nach Kamera immer zurück zur Frage
    ...
    def open_camera(self):
        ...
        # Nach Kamera immer zurück zur Arduino-Frage
        self.show_question()
